...
public class MartianWeight {
	...
	public static void main(String[] args) {
		...
		//convert earthWeights to Martian weights
	/*	Wm = We * 0.378
		where 'Wm' is the weight on Mars, and 'We' is the weight on Earth*/
		for (int i = 0; i < earthWeights.length; i++){
			int currentWeight = Integer.parseInt(earthWeights[i]);
			double martianWeight = (currentWeight * 0.378d) ;

			System.out.println(currentWeight + " lbs. on Earth is " + martianWeight + " lbs. on Mars.");
		}
