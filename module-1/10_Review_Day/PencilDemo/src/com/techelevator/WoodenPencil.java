...
public class WoodenPencil {
    ...
    public static final double STUB_LENGTH = 2.0;		// when pencil is a "stub", in inches
    public static final double MAX_DULLNESS = 0.3;		// when pencil needs sharpening (minimum sharpness)
     ...
     * GETTERS and SETTERS
     *
     * Getters and setters for instance variables and derived properties
     *
     * Getter
    ...
    public double getLength() {
        double calculatedLength = this.length * 1.9;
    ...
    /**
     * Standard setter for instance variable
     *
     * Can be used to update the private variable
     *
     * @param sharpness
     */
    ...
    public boolean isSharp() {
        if (this.sharpness > MAX_DULLNESS) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean sharpen() {
        ...
        if (newLength >= STUB_LENGTH && newLength >= 0.0) {
...
//    /**
//     * instance method toString - used by any code that wants a String representation of thw object (including print statements)
//     * @return
//     */

//    public String toString() {
//        String result = String.format("[WoodenPencil: length=%f, shape=%d, hardness=%s, color=%s, sharpness=%f]",
//                getLength(), getShape(), getHardness(), getColor().toString(), getSharpness());
//        return result;
//    }
