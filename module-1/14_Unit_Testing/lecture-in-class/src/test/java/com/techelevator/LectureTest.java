...
//	}
	...
	@Test
	public void AnimalGroupName_knowAnimalRhino_ReturnsCrash(){

		//Arrange

		//Act
		String herdName = exercises.animalGroupName("rhino");

		//Assert
		String expectedResult = "Crash";
		Assert.assertEquals(expectedResult, herdName);
	}

	@Test
	public void AnimalGroupName_UnknowAnimal_ReturnUnknown(){

		//Arrange

		//Act
		String herdName = exercises.animalGroupName("otter");
	...
	@Test
	public void AnimalGroupName_MixedCaseGiraffe_ReturnTower(){

		//Arrange

		//Act
		String herdName = exercises.animalGroupName("GiRaFfE");
	...
	@Test
	public void AnimalGroupName_MoreThanOneAssert_ReturnUnknown(){

		//Arrange

		//Act
		String herdName = exercises.animalGroupName("");
		String herdName2 = exercises.animalGroupName("elephants");

		//Assert
		String expectedResult = "unknown";
		Assert.assertEquals(expectedResult, herdName);
		Assert.assertEquals(expectedResult, herdName2);
	}
}
