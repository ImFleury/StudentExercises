...
//		if (animalName != null){
//			String lowerCaseAnimal = animalName.toLowerCase();
//			return animals.getOrDefault(lowerCaseAnimal, "unknown");
//		}
//
//		return "unknown";
//-============================================================
...
//
		for(String word : words){
			if (!result.containsKey(word)){ result.put(word, false);}
			else {result.put(word, true);}
