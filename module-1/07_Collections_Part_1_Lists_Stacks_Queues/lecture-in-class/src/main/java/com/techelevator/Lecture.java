...
//		System.out.println("Samwise is in the list : "+ inList);
        ...
        System.out.println("foreach in array");
	...
	private static List<String> AddNameToList(String name, List<String> namesList){
