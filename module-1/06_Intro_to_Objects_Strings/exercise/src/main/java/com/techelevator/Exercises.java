...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		String lastTwoLetters = str.substring(len);
	...
	public String right2(String str) {
		...
		String endingTwo = str.substring(length - 2);
		String movingEnding = str.substring(0, length - 2);

		return endingTwo + movingEnding;
	}
