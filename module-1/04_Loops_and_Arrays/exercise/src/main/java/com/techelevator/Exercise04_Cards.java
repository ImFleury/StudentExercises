...
public class Exercise04_Cards {
    ...
    */
    ...
    public String[] discardFirstCard(String[] hand) {
        String[] newSickCardArrayHack = new String[4];
        newSickCardArrayHack[0] = hand[1];
        newSickCardArrayHack[1] = hand[2];
        newSickCardArrayHack[2] = hand[3];
        newSickCardArrayHack[3] = hand[4];

        return newSickCardArrayHack;
    }
    ...
    public String[] discardTopCard(String[] remainingDeck) {
        ...
        String[] newDeckArray = new String[remainingDeck.length - 1];
        for (int i = 0; i < newDeckArray.length; i++) {
            newDeckArray[i] = remainingDeck[i+1];
        }
        return newDeckArray;
    }
}
