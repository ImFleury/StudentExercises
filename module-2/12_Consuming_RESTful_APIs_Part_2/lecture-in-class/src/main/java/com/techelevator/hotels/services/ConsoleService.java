...
public class ConsoleService {
    ...
    public void printMainMenu() {
        ...
        System.out.println("6: List all Hotel Reservations");
    ...
    public void printHotelReservations(List<HotelReservation> hotelReservationList){
        System.out.println("--------------------------------------------");
        for(HotelReservation hr: hotelReservationList){
