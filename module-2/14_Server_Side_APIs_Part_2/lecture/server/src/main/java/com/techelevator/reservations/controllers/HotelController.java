...
public class HotelController {
    ...
    @RequestMapping(path = "/hotels/{id}/reservations/{reservationId}", method =  RequestMethod.PUT)
    public void updateReservation(@RequestBody Reservation reservation, @PathVariable int id, @PathVariable int reservationId) throws ReservationNotFoundException {
        reservationDao.update(reservation, reservationId);
    }
    @RequestMapping(path = "/reservations/{reservationId}", method =  RequestMethod.PUT)
    public boolean updateReservation(@RequestBody Reservation reservation, @PathVariable int reservationId) throws ReservationNotFoundException {
        reservationDao.update(reservation, reservationId);
    ...
    @RequestMapping(path = "/hotels/{id}/reservations/{reservationId}", method = RequestMethod.DELETE)
    public void deleteReservation(@PathVariable int id, @PathVariable int reservationId) throws ReservationNotFoundException {
